 ...
 * </pre>
 *
 * @author Abel Tatek and Reniel Gall
 *
 */
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final void multiplyBy10(int k) {
        ...
        //the only time nothing is done is when this.rep is 0 ("") and k is 0
    ...
    public final int divideBy10() {
        ...
        if (!this.rep.equals("")) {
            remainder = Integer.parseInt(this.rep.substring(this.rep.length() - 1));
